...
public class form1 extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        radioButton2 = new RadioButton("Pharmacy");
        ...
        courses2 = FXCollections.observableArrayList("Biology", "Chemistry", "Calculus", "Physiology");
        ...
        activity2CheckBox = new CheckBox("Reading");
    ...
    private void displayStudentInformation() {
        ...
        String major = radioButton1.isSelected() ? "Software engineering" : radioButton2.isSelected() ? "Pharmacy" : "Not Selected";
        ...
        if (activity1CheckBox.isSelected()) studentInfo.append("Sports");
        if (activity2CheckBox.isSelected()) studentInfo.append("Reading");
